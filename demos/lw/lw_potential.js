/* @ts-self-types="./lw_potential.d.ts" */
 ...
 * @param {number} t
 */
export function render_field(buffer, width, height, t) {
    var ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.render_field(ptr0, len0, buffer, width, height, t);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lw_potential_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
